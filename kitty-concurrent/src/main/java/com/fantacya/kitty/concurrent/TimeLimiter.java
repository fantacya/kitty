...
/**
 * @description: Imposes a time limit on method calls. This is a copy from guava com.google.common.util.concurrent.TimeLimiter
 * @author: harri2012
 * @created: 2019-08-04 22:51
 */
public interface TimeLimiter {
     ...
     * @param timeout with timeoutDuration, the maximum length of time that callers are willing to
     ...
     */
    <T> T newProxy(T target, Class<T> interfaceType, Duration timeout);
     ...
     */
    <T> T callWithTimeout(Callable<T> callable, Duration timeout)
     ...
     * @throws ExecutionError if {@code callable} throws an {@code Error}
     */
    <T> T callUninterruptiblyWithTimeout(Callable<T> callable, Duration timeout) throws TimeoutException, ExecutionException;
     ...
     */
    void runWithTimeout(Runnable runnable, Duration timeout) throws TimeoutException, InterruptedException;
     ...
     * @throws ExecutionError if {@code runnable} throws an {@code Error}
     */
    void runUninterruptiblyWithTimeout(Runnable runnable, Duration timeout) throws TimeoutException;
}
